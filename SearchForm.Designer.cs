...
namespace Блокнот
{
	partial class SearchForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Заменить все";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(297, 124);
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(437, 124);
			...
			this.Load += new System.EventHandler(this.SearchForm_Shown);
